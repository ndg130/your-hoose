...
export default function Footer() {
    ...
    return (
        <footer className="bg-primaryyy bg-red-400 text-accent-dark">
            <div className="mx-auto max-w-7xl overflow-hidden px-6 py-12 sm:py-16 lg:px-8">
                ...
                <Link to="/properties" className="text-accent-dark hover:text-complement-deep">Properties</Link>
                </nav>
{/*                 <div className="mt-16 flex justify-center gap-x-10">
                ...
                <p className="mt-10 text-center text-sm/6 text-theme-800">&copy; {new Date().getFullYear()} Your Hoose - All rights reserved.</p>
            </div>
        </footer>
    )
}
