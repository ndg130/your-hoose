                ...
                <div className="rounded-lg bg-primary px-5 py-5">
                    ...
                    <div className="flex flex-col md:flex-row gap-y-5 gap-x-5">
                        ...
                        <div className="grid md:flex md:flex-nowrap grid-cols-2 gap-x-5 justify-between md:justify-end flex-shrink-0">
                            <Link to={`${basePath}/properties`} className="flex items-center justify-center text-center px-4 py-3 md:py-1 rounded-lg text-sm font-medium bg-complement-medium hover:bg-complement-deep hover:text-white transition-colors duration-200">
                            For sale
                            </Link>
                            <Link to={`${basePath}/properties`} className="flex items-center justify-center text-center px-4 py-3 md:py-1 rounded-lg text-sm font-medium bg-complement-medium hover:bg-complement-deep hover:text-white transition-colors duration-200">
                            To rent
