...
export default function AddProperty() {
    ...
    // const [testFormData, setTestFormData] = useState(initialFormState);
    ...
    const [formData, setFormData] = useState({
        ...
        details: {
            ...
            media: property?.details?.media || [],
            imageUrl: property?.details?.imageUrl || "",
            maxNumber: property?.details?.maxNumber || "",
            property_type: property?.details?.property_type || "",
            reception_rooms: property?.details?.reception_rooms || "",
            status: property?.details?.status || ""
        },
        listing_date: property?.listing_date || "",
        price: {
            amount: property?.price?.amount || "",
            frequency: property?.price?.frequency || "",
            qualifier: property?.price?.qualifier || ""
        },
